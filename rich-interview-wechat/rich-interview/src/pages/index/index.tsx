...
import {AtCard, AtDrawer, AtIcon, AtList, AtListItem} from 'taro-ui';
import {getHotQuestionBanks, getNewQuestionBanks,} from '../../api/questionBank';
import {getHotQuestions, getNewQuestions} from '../../api/question';
import {getLoginUser, userLogin, userRegister} from '../../api/user';
import TagParser from '../../components/TagParserComponent/index';
import PreviousQuestionCard from '../../components/PreviousQuestionCard/index';
      ...
      <View className='index-container'>
        ...
        <ScrollView className='index-page' scrollY>
          ...
          <PreviousQuestionCard
            userInfo={userInfo}
            onNavigateToQuestion={this.handleNavigateToQuestion}
          />
